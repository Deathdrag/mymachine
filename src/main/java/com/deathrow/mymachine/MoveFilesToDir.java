...
public class MoveFilesToDir{
	
	public  HashMap<String, String> hashmap = new HashMap<String, String>();
	public  HashMap<String, String> dupHashMap = new HashMap<String, String>();
	...
	public  void dupScan(String folderToScan) {
        ...
        new Task_IntegerUpdate(jpb, max, label,folderToScan).execute();
    }
    ...
    class Task_IntegerUpdate extends SwingWorker<Void, Integer> {
        ...
        public Task_IntegerUpdate(JProgressBar jpb, int max, JLabel label,  String folderToScan) {
            this.jpb = jpb;
            this.max = max;
            this.label = label;
